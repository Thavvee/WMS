...
const MapComponent_113_B = () => {
  ...
  const [zones, setZones] = useState([
    ...
    // { x: 60, y: 1110,col:'72',row:'1',warehouse: '113',zone:'A',mapid:'721',highestL:'0',width:'60px',height:'35px'},
    // { x: 60, y: 1150,col:'72',row:'2',warehouse: '113',zone:'A',mapid:'722',highestL:'0',width:'60px',height:'35px'},
    // { x: 60, y: 1190,col:'72',row:'3',warehouse: '113',zone:'A',mapid:'723',highestL:'0',width:'60px',height:'35px'},



    // { x: 140, y: 1110,col:'71',row:'1',warehouse: '113',zone:'A',mapid:'711',highestL:'0',width:'60px',height:'35px'},
    // { x: 140, y: 1150,col:'71',row:'2',warehouse: '113',zone:'A',mapid:'712',highestL:'0',width:'60px',height:'35px'},
    // { x: 140, y: 1190,col:'71',row:'3',warehouse: '113',zone:'A',mapid:'713',highestL:'0',width:'60px',height:'35px'},



    // { x: 220, y: 1110,col:'70',row:'1',warehouse: '113',zone:'A',mapid:'701',highestL:'0',width:'60px',height:'35px'},
    // { x: 220, y: 1150,col:'70',row:'2',warehouse: '113',zone:'A',mapid:'702',highestL:'0',width:'60px',height:'35px'},
    // { x: 220, y: 1190,col:'70',row:'3',warehouse: '113',zone:'A',mapid:'703',highestL:'0',width:'60px',height:'35px'},



    // { x: 300, y: 1110,col:'69',row:'1',warehouse: '113',zone:'A',mapid:'691',highestL:'0',width:'60px',height:'35px'},
    // { x: 300, y: 1150,col:'69',row:'2',warehouse: '113',zone:'A',mapid:'692',highestL:'0',width:'60px',height:'35px'},
    // { x: 300, y: 1190,col:'69',row:'3',warehouse: '113',zone:'A',mapid:'693',highestL:'0',width:'60px',height:'35px'},
  ...
  const [zone_v, setZone_v] = useState([
    ...
    {  x: 500, y: 100, col:'55' , mapid:'1' },
    {  x: 500, y: 170, col:'56' , mapid:'2'},
    {  x: 500, y: 240, col:'57' , mapid:'3'},
    {  x: 500, y: 310, col:'58' , mapid:'4'},
    {  x: 500, y: 380, col:'59' , mapid:'5'},
    {  x: 500, y: 450, col:'60' , mapid:'6'},
    {  x: 500, y: 520, col:'61' , mapid:'7'},
    {  x: 500, y: 590, col:'62' , mapid:'8'},
    {  x: 500, y: 660, col:'63' , mapid:'9'},
    {  x: 500, y: 730,col:'64' , mapid:'10'},
    {  x: 500, y: 800,col:'65' , mapid:'11'},
    {  x: 500, y: 870,col:'66' , mapid:'12'},
    {  x: 500, y: 940,col:'67' , mapid:'13'},
    {  x: 500, y: 1010,col:'68' , mapid:'14'},
    {  x: 300, y: 1300,col:'69' , mapid:'15',width:'60px',height:'35px'},
    {  x: 220, y: 1300,col:'70' , mapid:'16',width:'60px',height:'35px'},
    {  x: 140, y: 1300,col:'71' , mapid:'17',width:'60px',height:'35px'},
    {  x: 60, y: 1300,col:'72' , mapid:'18',width:'60px',height:'35px'},
...
export default MapComponent_113_B;
