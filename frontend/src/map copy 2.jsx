...
import { Tooltip, Box, Card,StackDivider,FormControl,FormLabel,HStack, CardHeader, CardBody, Text, Select,Flex,Center,Square,Container, VStack } from "@chakra-ui/react";
...
>
  ...
  <GridItem colSpan={1} row={2} bg='white' >
  {selectedOption && (
    <Box p='5'> 
      <Box p='4'>
